...
import 'package:ibafass/view/settings/approvalsettings/resignationnotice.dart';
class OfferApproval extends StatefulWidget {
  const OfferApproval({Key? key}) : super(key: key);

  @override
  _OfferApprovalState createState() => _OfferApprovalState();
}

class _OfferApprovalState extends State<OfferApproval> {
  bool Selected=true;
  @override
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: (){
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => const ResignationNotice()),
                                );
                              },
                              child: Container(
                                height: MediaQuery.of(context).size.height/5,
                        ...
                        Padding(
                          ...
                          child: Text('Offer approval Settings',style: TextStyle(color: Colors.black,fontSize: 17,fontWeight: FontWeight.bold),),
                        ),
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(left: 20.0),
                                  child: Text('Leave Approver',style: TextStyle(fontWeight:FontWeight.bold,fontSize: 15,color: Colors.black),),
                                ),
                                SizedBox(height: 20,),
                                Padding(
                                  padding: const EdgeInsets.only(left: 20.0),
