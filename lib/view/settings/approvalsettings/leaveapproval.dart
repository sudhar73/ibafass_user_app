                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  boxShadow: [BoxShadow(offset: Offset(0,3.0),blurRadius: 6,color: Colors.grey)],
                                  color: HexColor('#00A115'),
                                  borderRadius: BorderRadius.all(Radius.circular(20.0))),
                              child:  Column(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: [Image(image: AssetImage('assets/settings/leaveapprovalboldicon.png')),
                                    SizedBox(height: 10,),
                        ...
                        Padding(
                          ...
                          child: Text('Leave approval Settings',style: TextStyle(color: Colors.black,fontSize: 17,fontWeight: FontWeight.bold),),
                        ),
                        Padding(
